  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Artisanal ice cream scoops in waffle cones"
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        <h1
          className="font-heading text-4xl md:text-6xl lg:text-7xl font-semibold text-primary-foreground mb-6 opacity-0 animate-fade-up"
        >
        ...
        >
          Made in-house with just a handful of fresh ingredients and inspired by the
          world's best artisan producers and local farmers.
        </p>
        <div
